...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level22); //Установить текст
        ...
        textdesc.setText(R.string.level_22);
        ...
        textdescEnd.setText(R.string.level_22End);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level22.this, Level23.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_do[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_do[numRight]);
        text_right.setText(" ");
