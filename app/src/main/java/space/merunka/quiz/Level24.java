...
public class Level24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level24); //Установить текст
        ...
        textdesc.setText(R.string.level_24);
        ...
        textdescEnd.setText(R.string.level_24End);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level24.this, Level25.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_kai[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_kai[numRight]);
        text_right.setText(" ");
