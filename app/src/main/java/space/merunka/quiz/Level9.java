...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level9); //Установить текст
        ...
        textdesc.setText(R.string.levelnine);
        ...
        textdescEnd.setText(R.string.levelnineEnd);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level9.this, Level10.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_lay[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_lay[numRight]);
        text_right.setText(" ");
