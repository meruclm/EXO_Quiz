...
public class Level21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level21); //Установить текст
        ...
        textdesc.setText(R.string.level_21);
        ...
        textdescEnd.setText(R.string.level_21End);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level21.this, Level22.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_xiu[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_xiu[numRight]);
        text_right.setText(" ");
