...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level2); //Установить текст
...
/*
        ...
        previewimg.setImageResource(R.drawable.levels_one_four_img_back);
...
*/
        ...
        textdesc.setText(R.string.leveltwo);
        ...
        textdescEnd.setText(R.string.leveltwoEnd);
        ...
        numLeft = random.nextInt(9); //Генерация случайных чисел 0-8
        img_left.setImageResource(array.images1[numLeft]);
        text_left.setText(array.texts1[numLeft]);

        numRight = random.nextInt(9); //Генерация случайных чисел 0-8
