...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level7); //Установить текст
        ...
        textdesc.setText(R.string.levelseven);
        ...
        textdescEnd.setText(R.string.levelsevenEnd);
        ...
        img_left.setImageResource(array.images_se[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_se[numRight]);
        text_right.setText(" ");
