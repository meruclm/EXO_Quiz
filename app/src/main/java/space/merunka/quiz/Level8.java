...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level8); //Установить текст
        ...
        textdesc.setText(R.string.leveleight);
        ...
        textdescEnd.setText(R.string.leveleightEnd);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level8.this, Level9.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_chen[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_chen[numRight]);
        text_right.setText(" ");
