...
public class Level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level12); //Установить текст
        ...
        textdesc.setText(R.string.level_12);
        ...
        textdescEnd.setText(R.string.level_12End);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level12.this, Level13.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_baek[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_baek[numRight]);
        text_right.setText(" ");
