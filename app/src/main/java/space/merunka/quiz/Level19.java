...
public class Level19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level19); //Установить текст
        ...
        textdesc.setText(R.string.level_19);
        ...
        textdescEnd.setText(R.string.level_19End);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level19.this, Level20.class); //HEREEEEEEEEEE
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
        ...
        img_left.setImageResource(array.images_suho[numLeft]);
        text_left.setText(" ");
        ...
        img_right.setImageResource(array.images_suho[numRight]);
        text_right.setText(" ");
